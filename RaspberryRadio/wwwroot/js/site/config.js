...
//Seitennavigation
var confUrl = window.location.href.toLowerCase();

if (confUrl.includes('token') && confUrl.includes('conf')) {
    showConfArea('confAreaToken');
}
else if (confUrl.includes('weather') && confUrl.includes('conf')) {
    showConfArea('confAreaWeather');
}
else if (confUrl.includes('calendar') && confUrl.includes('conf')) {
    showConfArea('confAreaCalendar');
}
else if (confUrl.includes('radio') && confUrl.includes('conf')) {
...
function editDailyScripture(id) {
    var url = '/api/dailyScripturesLanguages/' + id;
...
function loadOpenWeatherCities(shortCountry) {
    ...
    xhttp.open('GET', '/api/openWeather/search/' + shortCountry, false);
...
function editCalendar(id) {
    ...
    $.getJSON(url, function (data) {
        document.getElementById('calendarFormId').value = data.id;
        document.getElementById('calendarFormName').value = data.name;
        document.getElementById('calendarFormUsername').value = data.username;
        document.getElementById('calendarFormPassword').value = data.password;
        document.getElementById('calendarFormUrl').value = data.url;
    });
